...
class AddUserCommand extends Command
{
    ...
    public function __construct(
        ...
        private PersonLoginInfoRepository $users
    ) {
        parent::__construct();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $details_user = new PersonDetails();
        $details_user->setPersonLoginInfo($user);

        $this->entityManager->persist($details_user);

        $this->entityManager->flush();

        $this->io->success(sprintf('%s was successfully created: (%s)', 'Administrator user', /*$user->getUsername(),*/ $user->getEmail()));
